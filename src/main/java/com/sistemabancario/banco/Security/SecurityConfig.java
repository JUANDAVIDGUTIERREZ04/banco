...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            .csrf(csrf -> csrf.disable()) // Deshabilitar CSRF (considera habilitarlo según tus necesidades)
            ...
            .formLogin(form -> form
                ...
                .defaultSuccessUrl("/default", true) // Redirigir a la página por defecto después de un login exitoso
